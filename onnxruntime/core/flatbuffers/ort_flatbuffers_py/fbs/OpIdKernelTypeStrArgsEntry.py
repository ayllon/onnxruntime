...
def Start(builder):
    return OpIdKernelTypeStrArgsEntryStart(builder)
...
def AddOpId(builder, opId):
    return OpIdKernelTypeStrArgsEntryAddOpId(builder, opId)
...
def AddKernelTypeStrArgs(builder, kernelTypeStrArgs):
    return OpIdKernelTypeStrArgsEntryAddKernelTypeStrArgs(builder, kernelTypeStrArgs)
