...
def Start(builder):
    return RuntimeOptimizationRecordStart(builder)
...
def AddActionId(builder, actionId):
    return RuntimeOptimizationRecordAddActionId(builder, actionId)
...
def AddNodesToOptimizeIndices(builder, nodesToOptimizeIndices):
    return RuntimeOptimizationRecordAddNodesToOptimizeIndices(builder, nodesToOptimizeIndices)
...
def AddProducedOpIds(builder, producedOpIds):
    return RuntimeOptimizationRecordAddProducedOpIds(builder, producedOpIds)
