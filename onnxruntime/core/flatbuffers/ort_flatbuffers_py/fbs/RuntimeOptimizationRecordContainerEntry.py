...
def Start(builder):
    return RuntimeOptimizationRecordContainerEntryStart(builder)
...
def AddOptimizerName(builder, optimizerName):
    return RuntimeOptimizationRecordContainerEntryAddOptimizerName(builder, optimizerName)
...
def AddRuntimeOptimizationRecords(builder, runtimeOptimizationRecords):
    return RuntimeOptimizationRecordContainerEntryAddRuntimeOptimizationRecords(builder, runtimeOptimizationRecords)
