...
def Start(builder):
    return DeprecatedSubGraphSessionStateStart(builder)
...
def AddGraphId(builder, graphId):
    return DeprecatedSubGraphSessionStateAddGraphId(builder, graphId)
...
def AddSessionState(builder, sessionState):
    return DeprecatedSubGraphSessionStateAddSessionState(builder, sessionState)
