...
def AddDocString(builder, docString):
    return NodeAddDocString(builder, docString)
...
def AddDomain(builder, domain):
    return NodeAddDomain(builder, domain)
...
def AddSinceVersion(builder, sinceVersion):
    return NodeAddSinceVersion(builder, sinceVersion)
def NodeAddIndex(builder, index): builder.PrependUint32Slot(4, index, 0)
def AddIndex(builder, index):
    return NodeAddIndex(builder, index)
...
def AddOpType(builder, opType):
    return NodeAddOpType(builder, opType)
def NodeAddType(builder, type): builder.PrependInt32Slot(6, type, 0)
def AddType(builder, type):
    return NodeAddType(builder, type)
...
def AddExecutionProviderType(builder, executionProviderType):
    return NodeAddExecutionProviderType(builder, executionProviderType)
...
def AddAttributes(builder, attributes):
    return NodeAddAttributes(builder, attributes)
...
def AddInputArgCounts(builder, inputArgCounts):
    return NodeAddInputArgCounts(builder, inputArgCounts)
...
def AddImplicitInputs(builder, implicitInputs):
    return NodeAddImplicitInputs(builder, implicitInputs)
