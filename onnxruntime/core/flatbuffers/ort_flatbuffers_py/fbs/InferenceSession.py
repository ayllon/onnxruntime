...
def Start(builder):
    return InferenceSessionStart(builder)
...
def AddOrtVersion(builder, ortVersion):
    return InferenceSessionAddOrtVersion(builder, ortVersion)
...
def AddModel(builder, model):
    return InferenceSessionAddModel(builder, model)
...
def AddKernelTypeStrResolver(builder, kernelTypeStrResolver):
    return InferenceSessionAddKernelTypeStrResolver(builder, kernelTypeStrResolver)
